...
#define __PYX_HAVE__fastreid__evaluation__rank_cylib__roc_cy
#define __PYX_HAVE_API__fastreid__evaluation__rank_cylib__roc_cy
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
...
/* Module declarations from 'fastreid.evaluation.rank_cylib.roc_cy' */
...
static PyObject *__pyx_f_8fastreid_10evaluation_10rank_cylib_6roc_cy_evaluate_roc_cy(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "fastreid.evaluation.rank_cylib.roc_cy"
int __pyx_module_is_main_fastreid__evaluation__rank_cylib__roc_cy = 0;

/* Implementation of 'fastreid.evaluation.rank_cylib.roc_cy' */
...
static PyObject *__pyx_pf_8fastreid_10evaluation_10rank_cylib_6roc_cy_evaluate_roc_cy(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_distmat, __Pyx_memviewslice __pyx_v_q_feats, __Pyx_memviewslice __pyx_v_g_feats, __Pyx_memviewslice __pyx_v_q_pids, __Pyx_memviewslice __pyx_v_g_pids, __Pyx_memviewslice __pyx_v_q_camids, __Pyx_memviewslice __pyx_v_g_camids); /* proto */
...
/* "fastreid/evaluation/rank_cylib/roc_cy.pyx":20
 * 
 * # Main interface
...
static PyObject *__pyx_f_8fastreid_10evaluation_10rank_cylib_6roc_cy_evaluate_roc_cy(__Pyx_memviewslice __pyx_v_distmat, __Pyx_memviewslice __pyx_v_q_feats, __Pyx_memviewslice __pyx_v_g_feats, __Pyx_memviewslice __pyx_v_q_pids, __Pyx_memviewslice __pyx_v_g_pids, __Pyx_memviewslice __pyx_v_q_camids, __Pyx_memviewslice __pyx_v_g_camids, CYTHON_UNUSED int __pyx_skip_dispatch) {
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":23
 *                   long[:]q_camids, long[:]g_camids):
 * 
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":24
 * 
 *     distmat = np.asarray(distmat, dtype=np.float32)
 *     q_feats = np.asarray(q_feats, dtype=np.float32)             # <<<<<<<<<<<<<<
 *     g_feats = np.asarray(g_feats, dtype=np.float32)
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":25
 *     distmat = np.asarray(distmat, dtype=np.float32)
 *     q_feats = np.asarray(q_feats, dtype=np.float32)
 *     g_feats = np.asarray(g_feats, dtype=np.float32)             # <<<<<<<<<<<<<<
 *     q_pids = np.asarray(q_pids, dtype=np.int64)
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":26
 *     q_feats = np.asarray(q_feats, dtype=np.float32)
 *     g_feats = np.asarray(g_feats, dtype=np.float32)
 *     q_pids = np.asarray(q_pids, dtype=np.int64)             # <<<<<<<<<<<<<<
 *     g_pids = np.asarray(g_pids, dtype=np.int64)
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":27
 *     g_feats = np.asarray(g_feats, dtype=np.float32)
 *     q_pids = np.asarray(q_pids, dtype=np.int64)
 *     g_pids = np.asarray(g_pids, dtype=np.int64)             # <<<<<<<<<<<<<<
 *     q_camids = np.asarray(q_camids, dtype=np.int64)
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":28
 *     q_pids = np.asarray(q_pids, dtype=np.int64)
 *     g_pids = np.asarray(g_pids, dtype=np.int64)
 *     q_camids = np.asarray(q_camids, dtype=np.int64)             # <<<<<<<<<<<<<<
 *     g_camids = np.asarray(g_camids, dtype=np.int64)
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":29
 *     g_pids = np.asarray(g_pids, dtype=np.int64)
 *     q_camids = np.asarray(q_camids, dtype=np.int64)
 *     g_camids = np.asarray(g_camids, dtype=np.int64)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":31
 *     g_camids = np.asarray(g_camids, dtype=np.int64)
 * 
 *     cdef long num_q = distmat.shape[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":32
 * 
 *     cdef long num_q = distmat.shape[0]
 *     cdef long num_g = distmat.shape[1]             # <<<<<<<<<<<<<<
 *     cdef long dim = q_feats.shape[1]
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":33
 *     cdef long num_q = distmat.shape[0]
 *     cdef long num_g = distmat.shape[1]
 *     cdef long dim = q_feats.shape[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":36
 * 
 *     cdef long[:,:] indices
 ...
 * 
 */
  __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_faiss); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 36, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":37
 *     cdef long[:,:] indices
 *     cdef index = faiss.IndexFlatL2(dim)
 *     index.add(np.asarray(g_feats))             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_asarray); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __pyx_memoryview_fromslice(__pyx_v_g_feats, 2, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 37, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_8 = NULL;
  ...
  if (!__pyx_t_8) {
    ...
    #endif
    {
      ...
      __pyx_t_4 = 0;
      __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_9, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 37, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":39
 *     index.add(np.asarray(g_feats))
 * 
 *     indices = index.search(np.asarray(q_feats), k=num_g)[1]             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_asarray); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = __pyx_memoryview_fromslice(__pyx_v_q_feats, 2, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 39, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_5 = NULL;
  ...
  if (!__pyx_t_5) {
    __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_1, __pyx_t_9); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 39, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    __Pyx_GOTREF(__pyx_t_3);
  } else {
    #if CYTHON_FAST_PYCALL
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_dsds_long(__pyx_t_3);
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":42
 * 
 *     cdef:
 ...
 */
  ...
  if (!__pyx_t_9) {
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_GOTREF(__pyx_t_4);
  } else {
    #if CYTHON_FAST_PYCALL
    ...
    #endif
    {
      ...
      __pyx_t_1 = 0;
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_5, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    }
  }
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_asarray); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_indices, 2, (PyObject *(*)(char *)) __pyx_memview_get_long, (int (*)(char *, PyObject *)) __pyx_memview_set_long, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_9 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_1))) {
  ...
  if (!__pyx_t_9) {
    ...
    #endif
    {
      ...
      __pyx_t_5 = 0;
      __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_8, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    }
  }
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_GetItem(__pyx_t_4, __pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_asarray); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  ...
  if (!__pyx_t_5) {
    __pyx_t_2 = __Pyx_PyObject_CallOneArg(__pyx_t_8, __pyx_t_4); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_GOTREF(__pyx_t_2);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_8)) {
      PyObject *__pyx_temp[2] = {__pyx_t_5, __pyx_t_4};
      __pyx_t_2 = __Pyx_PyFunction_FastCall(__pyx_t_8, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    } else
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_8)) {
      PyObject *__pyx_temp[2] = {__pyx_t_5, __pyx_t_4};
      __pyx_t_2 = __Pyx_PyCFunction_FastCall(__pyx_t_8, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    } else
    #endif
    {
      ...
      PyTuple_SET_ITEM(__pyx_t_9, 0+1, __pyx_t_4);
      __pyx_t_4 = 0;
      __pyx_t_2 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_9, NULL); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_2);
      __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
    }
  }
  ...
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_newaxis); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  ...
  __pyx_t_9 = 0;
  __pyx_t_9 = PyObject_GetItem(__pyx_t_2, __pyx_t_8); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = PyObject_RichCompare(__pyx_t_1, __pyx_t_9, Py_EQ); __Pyx_XGOTREF(__pyx_t_8); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_astype); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_int64); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = NULL;
  ...
  if (!__pyx_t_8) {
    __pyx_t_3 = __Pyx_PyObject_CallOneArg(__pyx_t_9, __pyx_t_1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_GOTREF(__pyx_t_3);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_9)) {
      ...
      __pyx_t_3 = __Pyx_PyFunction_FastCall(__pyx_t_9, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_8); __pyx_t_8 = 0;
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    } else
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_9)) {
      PyObject *__pyx_temp[2] = {__pyx_t_8, __pyx_t_1};
      __pyx_t_3 = __Pyx_PyCFunction_FastCall(__pyx_t_9, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_8); __pyx_t_8 = 0;
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    } else
    #endif
    {
      ...
      __pyx_t_1 = 0;
      __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_9, __pyx_t_2, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 42, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_3);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    }
  }
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_10 = __Pyx_PyObject_to_MemoryviewSlice_dsds_long(__pyx_t_3);
  if (unlikely(!__pyx_t_10.memview)) __PYX_ERR(0, 42, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_matches = __pyx_t_10;
  __pyx_t_10.memview = NULL;
  __pyx_t_10.data = NULL;

  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":44
 *         long[:,:] matches = (np.asarray(g_pids)[np.asarray(indices)] == np.asarray(q_pids)[:, np.newaxis]).astype(np.int64)
 * 
 *         float[:] pos = np.zeros(num_q*num_g, dtype=np.float32)             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_zeros); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_float32); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_t_8) < 0) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_9, __pyx_t_2, __pyx_t_3); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 44, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":45
 * 
 *         float[:] pos = np.zeros(num_q*num_g, dtype=np.float32)
 *         float[:] neg = np.zeros(num_q*num_g, dtype=np.float32)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_zeros); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyInt_From_long((__pyx_v_num_q * __pyx_v_num_g)); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  ...
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_float32); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  if (PyDict_SetItem(__pyx_t_8, __pyx_n_s_dtype, __pyx_t_1) < 0) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_2, __pyx_t_8); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_1);
  if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 45, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_v_neg = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;

  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":47
 *         float[:] neg = np.zeros(num_q*num_g, dtype=np.float32)
 * 
 *         long valid_pos = 0             # <<<<<<<<<<<<<<
 *         long valid_neg = 0
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":48
 * 
 *         long valid_pos = 0
 *         long valid_neg = 0             # <<<<<<<<<<<<<<
 *         long ind
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":52
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_zeros); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_int64); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_1, __pyx_n_s_dtype, __pyx_t_9) < 0) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = __Pyx_PyObject_Call(__pyx_t_8, __pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 52, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(__pyx_t_9);
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":54
 *         long[:] order = np.zeros(num_g, dtype=np.int64)
 * 
 *         float[:] raw_cmc = np.zeros(num_g, dtype=np.float32) # binary vector, positions with value 1 are correct matches             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_9);
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_9, __pyx_n_s_zeros); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_9 = __Pyx_PyInt_From_long(__pyx_v_num_g); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  ...
  __Pyx_GOTREF(__pyx_t_8);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_8, __pyx_n_s_float32); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  if (PyDict_SetItem(__pyx_t_9, __pyx_n_s_dtype, __pyx_t_3) < 0) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_2, __pyx_t_9); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_3);
  if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 54, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_v_raw_cmc = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;

  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":55
 * 
 *         float[:] raw_cmc = np.zeros(num_g, dtype=np.float32) # binary vector, positions with value 1 are correct matches
 *         long[:] sort_idx = np.zeros(num_g, dtype=np.int64)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_zeros); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_int64); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  if (PyDict_SetItem(__pyx_t_3, __pyx_n_s_dtype, __pyx_t_8) < 0) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_9, __pyx_t_2, __pyx_t_3); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 55, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_ds_long(__pyx_t_8);
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":59
 *         long idx
 * 
 ...
 */
  ...
  for (__pyx_t_13 = 0; __pyx_t_13 < __pyx_t_12; __pyx_t_13+=1) {
    ...
    /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":61
 *     for q_idx in range(num_q):
 *         # get query pid and camid
 *         q_pid = q_pids[q_idx]             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":62
 *         # get query pid and camid
 *         q_pid = q_pids[q_idx]
 *         q_camid = q_camids[q_idx]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":64
 *         q_camid = q_camids[q_idx]
 * 
 *         for g_idx in range(num_g):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
      ...
      /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":65
 * 
 *         for g_idx in range(num_g):
 *             order[g_idx] = indices[q_idx, g_idx]             # <<<<<<<<<<<<<<
 *         num_g_real = 0
 ...
 */
      ...
      *((long *) ( /* dim=0 */ (__pyx_v_order.data + __pyx_t_20 * __pyx_v_order.strides[0]) )) = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_indices.data + __pyx_t_18 * __pyx_v_indices.strides[0]) ) + __pyx_t_19 * __pyx_v_indices.strides[1]) )));
    }

    /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":66
 *         for g_idx in range(num_g):
 *             order[g_idx] = indices[q_idx, g_idx]
 *         num_g_real = 0             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":69
 * 
 *         # remove gallery samples that have the same pid and camid with query
 *         for g_idx in range(num_g):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    for (__pyx_t_17 = 0; __pyx_t_17 < __pyx_t_16; __pyx_t_17+=1) {
      ...
      /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":70
 *         # remove gallery samples that have the same pid and camid with query
 *         for g_idx in range(num_g):
 *             if (g_pids[order[g_idx]] != q_pid) or (g_camids[order[g_idx]] != q_camid):             # <<<<<<<<<<<<<<
 *                 raw_cmc[num_g_real] = matches[q_idx][g_idx]
 ...
 */
      ...
      if (__pyx_t_21) {
        ...
        /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":71
 *         for g_idx in range(num_g):
 *             if (g_pids[order[g_idx]] != q_pid) or (g_camids[order[g_idx]] != q_camid):
 *                 raw_cmc[num_g_real] = matches[q_idx][g_idx]             # <<<<<<<<<<<<<<
 *                 sort_idx[num_g_real] = order[g_idx]
 *                 num_g_real += 1
 */
        __pyx_t_7.data = __pyx_v_matches.data;
        __pyx_t_7.memview = __pyx_v_matches.memview;
        __PYX_INC_MEMVIEW(&__pyx_t_7, 0);
        {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_q_idx;
    Py_ssize_t __pyx_tmp_shape = __pyx_v_matches.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_matches.strides[0];
...
__pyx_t_7.shape[0] = __pyx_v_matches.shape[1];
__pyx_t_7.strides[0] = __pyx_v_matches.strides[1];
    __pyx_t_7.suboffsets[0] = -1;

__pyx_t_27 = __pyx_v_g_idx;
        __pyx_t_28 = __Pyx_PyIndex_AsSsize_t(__pyx_v_num_g_real); if (unlikely((__pyx_t_28 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 71, __pyx_L1_error)
        __pyx_t_29 = __pyx_t_28;
        *((float *) ( /* dim=0 */ (__pyx_v_raw_cmc.data + __pyx_t_29 * __pyx_v_raw_cmc.strides[0]) )) = (*((long *) ( /* dim=0 */ (__pyx_t_7.data + __pyx_t_27 * __pyx_t_7.strides[0]) )));
        __PYX_XDEC_MEMVIEW(&__pyx_t_7, 1);
        __pyx_t_7.memview = NULL;
        __pyx_t_7.data = NULL;

        /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":72
 *             if (g_pids[order[g_idx]] != q_pid) or (g_camids[order[g_idx]] != q_camid):
 *                 raw_cmc[num_g_real] = matches[q_idx][g_idx]
 *                 sort_idx[num_g_real] = order[g_idx]             # <<<<<<<<<<<<<<
 *                 num_g_real += 1
 ...
 */
        ...
        __pyx_t_28 = __Pyx_PyIndex_AsSsize_t(__pyx_v_num_g_real); if (unlikely((__pyx_t_28 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 72, __pyx_L1_error)
        __pyx_t_31 = __pyx_t_28;
        *((long *) ( /* dim=0 */ (__pyx_v_sort_idx.data + __pyx_t_31 * __pyx_v_sort_idx.strides[0]) )) = (*((long *) ( /* dim=0 */ (__pyx_v_order.data + __pyx_t_30 * __pyx_v_order.strides[0]) )));

        /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":73
 *                 raw_cmc[num_g_real] = matches[q_idx][g_idx]
 *                 sort_idx[num_g_real] = order[g_idx]
 *                 num_g_real += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
        __pyx_t_8 = __Pyx_PyInt_AddObjC(__pyx_v_num_g_real, __pyx_int_1, 1, 1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 73, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_8);
        __Pyx_DECREF_SET(__pyx_v_num_g_real, __pyx_t_8);
        __pyx_t_8 = 0;
 ...
 */
    ...
    /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":75
 *                 num_g_real += 1
 * 
 *         q_dist = distmat[q_idx]             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_11.data = __pyx_v_distmat.data;
    __pyx_t_11.memview = __pyx_v_distmat.memview;
...
__pyx_t_11.shape[0] = __pyx_v_distmat.shape[1];
__pyx_t_11.strides[0] = __pyx_v_distmat.strides[1];
    __pyx_t_11.suboffsets[0] = -1;

__pyx_t_8 = __pyx_memoryview_fromslice(__pyx_t_11, 1, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 75, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __PYX_XDEC_MEMVIEW(&__pyx_t_11, 1);
    __pyx_t_11.memview = NULL;
    __pyx_t_11.data = NULL;
    __Pyx_XDECREF_SET(__pyx_v_q_dist, __pyx_t_8);
    __pyx_t_8 = 0;

    /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":77
 *         q_dist = distmat[q_idx]
 * 
 *         for valid_idx in range(num_g_real):             # <<<<<<<<<<<<<<
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_INCREF(__pyx_v_num_g_real);
    __Pyx_GIVEREF(__pyx_v_num_g_real);
    PyTuple_SET_ITEM(__pyx_t_8, 0, __pyx_v_num_g_real);
    __pyx_t_3 = __Pyx_PyObject_Call(__pyx_builtin_range, __pyx_t_8, NULL); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 77, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
    if (likely(PyList_CheckExact(__pyx_t_3)) || PyTuple_CheckExact(__pyx_t_3)) {
      __pyx_t_8 = __pyx_t_3; __Pyx_INCREF(__pyx_t_8); __pyx_t_28 = 0;
      __pyx_t_32 = NULL;
    } else {
      __pyx_t_28 = -1; __pyx_t_8 = PyObject_GetIter(__pyx_t_3); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 77, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __pyx_t_32 = Py_TYPE(__pyx_t_8)->tp_iternext; if (unlikely(!__pyx_t_32)) __PYX_ERR(0, 77, __pyx_L1_error)
    }
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    for (;;) {
      if (likely(!__pyx_t_32)) {
        if (likely(PyList_CheckExact(__pyx_t_8))) {
          ...
          __pyx_t_3 = PyList_GET_ITEM(__pyx_t_8, __pyx_t_28); __Pyx_INCREF(__pyx_t_3); __pyx_t_28++; if (unlikely(0 < 0)) __PYX_ERR(0, 77, __pyx_L1_error)
          #else
          __pyx_t_3 = PySequence_ITEM(__pyx_t_8, __pyx_t_28); __pyx_t_28++; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 77, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_3);
          #endif
        } else {
          if (__pyx_t_28 >= PyTuple_GET_SIZE(__pyx_t_8)) break;
          #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
          __pyx_t_3 = PyTuple_GET_ITEM(__pyx_t_8, __pyx_t_28); __Pyx_INCREF(__pyx_t_3); __pyx_t_28++; if (unlikely(0 < 0)) __PYX_ERR(0, 77, __pyx_L1_error)
          #else
          __pyx_t_3 = PySequence_ITEM(__pyx_t_8, __pyx_t_28); __pyx_t_28++; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 77, __pyx_L1_error)
          __Pyx_GOTREF(__pyx_t_3);
          #endif
      ...
      __Pyx_XDECREF_SET(__pyx_v_valid_idx, __pyx_t_3);
      __pyx_t_3 = 0;

      /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":78
 * 
 *         for valid_idx in range(num_g_real):
 *             if raw_cmc[valid_idx] == 1:             # <<<<<<<<<<<<<<
 *                 pos[valid_pos] = q_dist[sort_idx[valid_idx]]
 *                 valid_pos += 1
 */
      __pyx_t_33 = __Pyx_PyIndex_AsSsize_t(__pyx_v_valid_idx); if (unlikely((__pyx_t_33 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 78, __pyx_L1_error)
      __pyx_t_34 = __pyx_t_33;
      __pyx_t_21 = (((*((float *) ( /* dim=0 */ (__pyx_v_raw_cmc.data + __pyx_t_34 * __pyx_v_raw_cmc.strides[0]) ))) == 1.0) != 0);
      if (__pyx_t_21) {

        /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":79
 *         for valid_idx in range(num_g_real):
 *             if raw_cmc[valid_idx] == 1:
 *                 pos[valid_pos] = q_dist[sort_idx[valid_idx]]             # <<<<<<<<<<<<<<
 *                 valid_pos += 1
 ...
 */
        __pyx_t_33 = __Pyx_PyIndex_AsSsize_t(__pyx_v_valid_idx); if (unlikely((__pyx_t_33 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 79, __pyx_L1_error)
        __pyx_t_35 = __pyx_t_33;
        __pyx_t_16 = (*((long *) ( /* dim=0 */ (__pyx_v_sort_idx.data + __pyx_t_35 * __pyx_v_sort_idx.strides[0]) )));
        __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_q_dist, __pyx_t_16, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 79, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_36 = __pyx_PyFloat_AsFloat(__pyx_t_3); if (unlikely((__pyx_t_36 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 79, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_37 = __pyx_v_valid_pos;
        *((float *) ( /* dim=0 */ (__pyx_v_pos.data + __pyx_t_37 * __pyx_v_pos.strides[0]) )) = __pyx_t_36;

        /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":80
 *             if raw_cmc[valid_idx] == 1:
 *                 pos[valid_pos] = q_dist[sort_idx[valid_idx]]
 *                 valid_pos += 1             # <<<<<<<<<<<<<<
 *             elif raw_cmc[valid_idx] == 0:
 ...
 */
      ...
      /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":81
 *                 pos[valid_pos] = q_dist[sort_idx[valid_idx]]
 *                 valid_pos += 1
 *             elif raw_cmc[valid_idx] == 0:             # <<<<<<<<<<<<<<
 *                 neg[valid_neg] = q_dist[sort_idx[valid_idx]]
 *                 valid_neg += 1
 */
      __pyx_t_33 = __Pyx_PyIndex_AsSsize_t(__pyx_v_valid_idx); if (unlikely((__pyx_t_33 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 81, __pyx_L1_error)
      __pyx_t_38 = __pyx_t_33;
      __pyx_t_21 = (((*((float *) ( /* dim=0 */ (__pyx_v_raw_cmc.data + __pyx_t_38 * __pyx_v_raw_cmc.strides[0]) ))) == 0.0) != 0);
      if (__pyx_t_21) {

        /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":82
 *                 valid_pos += 1
 *             elif raw_cmc[valid_idx] == 0:
 *                 neg[valid_neg] = q_dist[sort_idx[valid_idx]]             # <<<<<<<<<<<<<<
 *                 valid_neg += 1
 * 
 */
        __pyx_t_33 = __Pyx_PyIndex_AsSsize_t(__pyx_v_valid_idx); if (unlikely((__pyx_t_33 == (Py_ssize_t)-1) && PyErr_Occurred())) __PYX_ERR(0, 82, __pyx_L1_error)
        __pyx_t_39 = __pyx_t_33;
        __pyx_t_16 = (*((long *) ( /* dim=0 */ (__pyx_v_sort_idx.data + __pyx_t_39 * __pyx_v_sort_idx.strides[0]) )));
        __pyx_t_3 = __Pyx_GetItemInt(__pyx_v_q_dist, __pyx_t_16, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 82, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_3);
        __pyx_t_36 = __pyx_PyFloat_AsFloat(__pyx_t_3); if (unlikely((__pyx_t_36 == (float)-1) && PyErr_Occurred())) __PYX_ERR(0, 82, __pyx_L1_error)
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
        __pyx_t_40 = __pyx_v_valid_neg;
        *((float *) ( /* dim=0 */ (__pyx_v_neg.data + __pyx_t_40 * __pyx_v_neg.strides[0]) )) = __pyx_t_36;

        /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":83
 *             elif raw_cmc[valid_idx] == 0:
 *                 neg[valid_neg] = q_dist[sort_idx[valid_idx]]
 *                 valid_neg += 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":85
 *                 valid_neg += 1
 * 
 *     cdef float[:] scores = np.hstack((pos[:valid_pos], neg[:valid_neg]))             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_hstack); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_11.data = __pyx_v_pos.data;
  __pyx_t_11.memview = __pyx_v_pos.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_11, 0);
  __pyx_t_41 = -1;
...
__pyx_t_3 = __pyx_memoryview_fromslice(__pyx_t_11, 1, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __PYX_XDEC_MEMVIEW(&__pyx_t_11, 1);
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;
  __pyx_t_11.data = __pyx_v_neg.data;
  __pyx_t_11.memview = __pyx_v_neg.memview;
  __PYX_INC_MEMVIEW(&__pyx_t_11, 0);
  __pyx_t_41 = -1;
  if (unlikely(__pyx_memoryview_slice_memviewslice(
    &__pyx_t_11,
...
__pyx_t_9 = __pyx_memoryview_fromslice(__pyx_t_11, 1, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __PYX_XDEC_MEMVIEW(&__pyx_t_11, 1);
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;
  ...
  if (!__pyx_t_9) {
    __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 85, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __Pyx_GOTREF(__pyx_t_8);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_2)) {
      PyObject *__pyx_temp[2] = {__pyx_t_9, __pyx_t_1};
      __pyx_t_8 = __Pyx_PyFunction_FastCall(__pyx_t_2, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 85, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_9); __pyx_t_9 = 0;
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    } else
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_2)) {
      PyObject *__pyx_temp[2] = {__pyx_t_9, __pyx_t_1};
      __pyx_t_8 = __Pyx_PyCFunction_FastCall(__pyx_t_2, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 85, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_9); __pyx_t_9 = 0;
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    } else
    #endif
    {
      ...
      __pyx_t_1 = 0;
      __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_t_3, NULL); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 85, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    }
  }
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_8);
  if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 85, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_v_scores = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;

  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":86
 * 
 *     cdef float[:] scores = np.hstack((pos[:valid_pos], neg[:valid_neg]))
 *     cdef float[:] labels = np.hstack((np.zeros(valid_pos, dtype=np.float32),             # <<<<<<<<<<<<<<
 *                                       np.ones(valid_neg, dtype=np.float32)))
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_hstack); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_long(__pyx_v_valid_pos); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_1, __pyx_t_9, __pyx_t_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;

  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":87
 *     cdef float[:] scores = np.hstack((pos[:valid_pos], neg[:valid_neg]))
 *     cdef float[:] labels = np.hstack((np.zeros(valid_pos, dtype=np.float32),
 *                                       np.ones(valid_neg, dtype=np.float32)))             # <<<<<<<<<<<<<<
 *     return np.asarray(scores), np.asarray(labels)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_9 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_ones); if (unlikely(!__pyx_t_9)) __PYX_ERR(0, 87, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_9);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = __Pyx_PyInt_From_long(__pyx_v_valid_neg); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 87, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_42 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_float32); if (unlikely(!__pyx_t_42)) __PYX_ERR(0, 87, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_42);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_t_42) < 0) __PYX_ERR(0, 87, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_42); __pyx_t_42 = 0;
  __pyx_t_42 = __Pyx_PyObject_Call(__pyx_t_9, __pyx_t_1, __pyx_t_2); if (unlikely(!__pyx_t_42)) __PYX_ERR(0, 87, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_42);
  __Pyx_DECREF(__pyx_t_9); __pyx_t_9 = 0;
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  if (!__pyx_t_42) {
    __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_2); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 86, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_GOTREF(__pyx_t_8);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_3)) {
      ...
      __pyx_t_8 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 86, __pyx_L1_error)
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[2] = {__pyx_t_42, __pyx_t_2};
      __pyx_t_8 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 86, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_42); __pyx_t_42 = 0;
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    } else
    #endif
    {
      ...
      __pyx_t_2 = 0;
      __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_5, NULL); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 86, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    }
  }
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_11 = __Pyx_PyObject_to_MemoryviewSlice_ds_float(__pyx_t_8);
  if (unlikely(!__pyx_t_11.memview)) __PYX_ERR(0, 86, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_v_labels = __pyx_t_11;
  __pyx_t_11.memview = NULL;
  __pyx_t_11.data = NULL;

  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":88
 *     cdef float[:] labels = np.hstack((np.zeros(valid_pos, dtype=np.float32),
 *                                       np.ones(valid_neg, dtype=np.float32)))
 *     return np.asarray(scores), np.asarray(labels)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_asarray); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 88, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __pyx_memoryview_fromslice(__pyx_v_scores, 1, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 88, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_2 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_5))) {
  ...
  if (!__pyx_t_2) {
    __pyx_t_8 = __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_t_3); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 88, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_GOTREF(__pyx_t_8);
  } else {
    #if CYTHON_FAST_PYCALL
    ...
    #endif
    {
      ...
      __Pyx_GIVEREF(__pyx_t_3);
      PyTuple_SET_ITEM(__pyx_t_42, 0+1, __pyx_t_3);
      __pyx_t_3 = 0;
      __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_42, NULL); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 88, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_8);
      __Pyx_DECREF(__pyx_t_42); __pyx_t_42 = 0;
    }
  }
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_42 = __Pyx_GetModuleGlobalName(__pyx_n_s_np); if (unlikely(!__pyx_t_42)) __PYX_ERR(0, 88, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_42);
  __pyx_t_3 = __Pyx_PyObject_GetAttrStr(__pyx_t_42, __pyx_n_s_asarray); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 88, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_42); __pyx_t_42 = 0;
  __pyx_t_42 = __pyx_memoryview_fromslice(__pyx_v_labels, 1, (PyObject *(*)(char *)) __pyx_memview_get_float, (int (*)(char *, PyObject *)) __pyx_memview_set_float, 0);; if (unlikely(!__pyx_t_42)) __PYX_ERR(0, 88, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_42);
  __pyx_t_2 = NULL;
  if (CYTHON_UNPACK_METHODS && unlikely(PyMethod_Check(__pyx_t_3))) {
  ...
  if (!__pyx_t_2) {
    __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_3, __pyx_t_42); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 88, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_42); __pyx_t_42 = 0;
    __Pyx_GOTREF(__pyx_t_5);
  } else {
    #if CYTHON_FAST_PYCALL
    if (PyFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[2] = {__pyx_t_2, __pyx_t_42};
      __pyx_t_5 = __Pyx_PyFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 88, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_42); __pyx_t_42 = 0;
    } else
    ...
    if (__Pyx_PyFastCFunction_Check(__pyx_t_3)) {
      PyObject *__pyx_temp[2] = {__pyx_t_2, __pyx_t_42};
      __pyx_t_5 = __Pyx_PyCFunction_FastCall(__pyx_t_3, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 88, __pyx_L1_error)
      __Pyx_XDECREF(__pyx_t_2); __pyx_t_2 = 0;
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_42); __pyx_t_42 = 0;
    } else
    #endif
    {
      ...
      __Pyx_GIVEREF(__pyx_t_42);
      PyTuple_SET_ITEM(__pyx_t_1, 0+1, __pyx_t_42);
      __pyx_t_42 = 0;
      __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_t_1, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 88, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    }
  }
 ...
 */
  ...
  __Pyx_AddTraceback("fastreid.evaluation.rank_cylib.roc_cy.evaluate_roc_cy", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_8fastreid_10evaluation_10rank_cylib_6roc_cy_1evaluate_roc_cy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_8fastreid_10evaluation_10rank_cylib_6roc_cy_1evaluate_roc_cy(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("evaluate_roc_cy (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        case  0:
        if (likely((values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_distmat)) != 0)) kw_args--;
        else goto __pyx_L5_argtuple_error;
        CYTHON_FALLTHROUGH;
        case  1:
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_q_feats)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate_roc_cy", 1, 7, 7, 1); __PYX_ERR(0, 20, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_g_feats)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate_roc_cy", 1, 7, 7, 2); __PYX_ERR(0, 20, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_q_pids)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate_roc_cy", 1, 7, 7, 3); __PYX_ERR(0, 20, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_g_pids)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate_roc_cy", 1, 7, 7, 4); __PYX_ERR(0, 20, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_q_camids)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("evaluate_roc_cy", 1, 7, 7, 5); __PYX_ERR(0, 20, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_g_camids)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_distmat = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[0]); if (unlikely(!__pyx_v_distmat.memview)) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_q_feats = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[1]); if (unlikely(!__pyx_v_q_feats.memview)) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_g_feats = __Pyx_PyObject_to_MemoryviewSlice_dsds_float(values[2]); if (unlikely(!__pyx_v_g_feats.memview)) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_q_pids = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[3]); if (unlikely(!__pyx_v_q_pids.memview)) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_g_pids = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[4]); if (unlikely(!__pyx_v_g_pids.memview)) __PYX_ERR(0, 20, __pyx_L3_error)
    __pyx_v_q_camids = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[5]); if (unlikely(!__pyx_v_q_camids.memview)) __PYX_ERR(0, 21, __pyx_L3_error)
    __pyx_v_g_camids = __Pyx_PyObject_to_MemoryviewSlice_ds_long(values[6]); if (unlikely(!__pyx_v_g_camids.memview)) __PYX_ERR(0, 21, __pyx_L3_error)
  }
  ...
  __pyx_r = __pyx_pf_8fastreid_10evaluation_10rank_cylib_6roc_cy_evaluate_roc_cy(__pyx_self, __pyx_v_distmat, __pyx_v_q_feats, __pyx_v_g_feats, __pyx_v_q_pids, __pyx_v_g_pids, __pyx_v_q_camids, __pyx_v_g_camids);
...
static PyObject *__pyx_pf_8fastreid_10evaluation_10rank_cylib_6roc_cy_evaluate_roc_cy(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_distmat, __Pyx_memviewslice __pyx_v_q_feats, __Pyx_memviewslice __pyx_v_g_feats, __Pyx_memviewslice __pyx_v_q_pids, __Pyx_memviewslice __pyx_v_g_pids, __Pyx_memviewslice __pyx_v_q_camids, __Pyx_memviewslice __pyx_v_g_camids) {
  ...
  __pyx_t_1 = __pyx_f_8fastreid_10evaluation_10rank_cylib_6roc_cy_evaluate_roc_cy(__pyx_v_distmat, __pyx_v_q_feats, __pyx_v_g_feats, __pyx_v_q_pids, __pyx_v_g_pids, __pyx_v_q_camids, __pyx_v_g_camids, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 20, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "fastreid.evaluation.rank_cylib.roc_cy.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "fastreid.evaluation.rank_cylib.roc_cy.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "fastreid.evaluation.rank_cylib.roc_cy.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "fastreid.evaluation.rank_cylib.roc_cy._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"evaluate_roc_cy", (PyCFunction)__pyx_pw_8fastreid_10evaluation_10rank_cylib_6roc_cy_1evaluate_roc_cy, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initroc_cy(void); /*proto*/
PyMODINIT_FUNC initroc_cy(void)
#else
PyMODINIT_FUNC PyInit_roc_cy(void); /*proto*/
PyMODINIT_FUNC PyInit_roc_cy(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_roc_cy(void)", 0);
  ...
  #endif
  if (__pyx_module_is_main_fastreid__evaluation__rank_cylib__roc_cy) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "fastreid.evaluation.rank_cylib.roc_cy")) {
      if (unlikely(PyDict_SetItemString(modules, "fastreid.evaluation.rank_cylib.roc_cy", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":5
 * 
 * import cython
 * import faiss             # <<<<<<<<<<<<<<
 * import numpy as np
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":6
 * import cython
 * import faiss
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "fastreid/evaluation/rank_cylib/roc_cy.pyx":1
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init fastreid.evaluation.rank_cylib.roc_cy", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init fastreid.evaluation.rank_cylib.roc_cy");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
